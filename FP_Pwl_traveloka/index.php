    ...
    <main>
        ...
        <div id="content">
            ...
            <article class="card">
                ...
                <center>
                    ...
                    <p><span style="color:royalblue;">0311343234</span> An. PT. Travel Nusa Perindo</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/mandiri.PNG" alt="mandiri" width="25%">
                    <p><span style="color:royalblue;">31002332432</span> An. PT. Travel Nusa Perindo</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/btn.PNG" alt="btn" width="25%">
                    <p><span style="color:royalblue;">129942422</span> An. PT. Travel Nusa Perindo</p>
                    <hr width="25%">
                    <br>
                </center>
                <center>
                    <img src="images/bri.PNG" alt="bri" width="25%">
                    <p><span style="color:royalblue;">031324455235</span> An. PT. Travel Nusa Perindo</p>
                </center>
            </article>
        </div>
        ...
        <aside>
            ...
            <article class="card">
                ...
                <center><img src="images/traveloka.png" width="100px"></center>
