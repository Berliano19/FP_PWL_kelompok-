<?php 
// koneksi ke database
$conn = mysqli_connect("localhost", "id18260379_travelokaweb", "Datasaya112~", "id18260379_traveloka");
...
function registrasi($data) {
	...
	mysqli_query($conn, "INSERT INTO user (username, password, nama)VALUES('$username', '$password', '$nama')");
...
function pesanan($data) {
	...
	// Masukkan Data ke Database
	mysqli_query($conn, "INSERT INTO bookings (username, kode_maskapai, nama, nohp, dari, tujuan, jam_berangkat, total_biaya, status) VALUES('$username',  '$kode_maskapai', '$nama', '$nohp', '$dari', '$tujuan', '$jam_berangkat', '$total_biaya', '$status')");
	return mysqli_affected_rows($conn);
}
